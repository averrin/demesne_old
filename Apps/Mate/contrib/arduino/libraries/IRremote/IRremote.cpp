 ...
 * For details, see http://sui77.wordpress.com/?p=261
 * Modified May 2011 Suat Özgür
 *
...
void IRsend::enableIROut(unsigned int khz) {
  irparams.pulselength = 500 / khz+1;
...
// To preserve compatibility to the unmodified version, default pin is #3
IRsend::IRsend()
{
  irparams.sendpin = 3;
  irparams.blinkflag = 0;
